...
This project aims to provide a practical and theoretical understanding of the evolution of language models, implementing the essential components of these architectures from scratch (or with a low level of abstraction using PyTorch). The final result includes functional models capable of generating coherent character-level text. Everything is explained in the PDF file.
